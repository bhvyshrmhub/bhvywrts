                  ...
                  <div className="py-1">
                    ...
                    {recent.map((term, i) => (
                      <button
                        ...
                        className="w-full flex items-center gap-3 px-3 py-2 text-sm text-foreground/80 hover:bg-secondary rounded-lg transition-colors text-left"
                      >
                        <Clock className="w-3.5 h-3.5 text-muted-foreground" />
                        {term}
                      </button>
                  ...
                  <div className="py-1">
                    {results.map((story) => (
                      <Link
                        ...
                        className="flex items-center justify-between gap-3 px-3 py-2.5 hover:bg-secondary rounded-lg transition-colors group"
                      >
