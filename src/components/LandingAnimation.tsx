    ...
    >
      ...
      <motion.div
        ...
        style={{
          ...
          boxShadow: "0 0 80px rgba(245, 240, 232, 0.2), 0 0 160px rgba(245, 240, 232, 0.1), 0 0 300px rgba(245, 240, 232, 0.04)",
          filter: "blur(0.3px)",
        }}
      >
        <div className="absolute top-[25%] left-[30%] w-7 h-7 rounded-full bg-black/10 blur-[1px]" />
        ...
        <motion.div
          ...
          animate={{
            boxShadow: [
              "0 0 80px rgba(245, 240, 232, 0.2), 0 0 160px rgba(245, 240, 232, 0.1)",
              "0 0 100px rgba(245, 240, 232, 0.35), 0 0 200px rgba(245, 240, 232, 0.15)",
              "0 0 80px rgba(245, 240, 232, 0.2), 0 0 160px rgba(245, 240, 232, 0.1)",
            ],
          }}
      ...
      <AnimatePresence mode="wait">
        {phase === "typing" && (
          ...
          >
            <span className="text-xl sm:text-2xl md:text-3xl text-white/70 font-light tracking-wide">
              {displayedText}
            </span>
            <motion.span
              animate={{ opacity: [1, 0] }}
        ...
        {phase === "brand" && (
          ...
          >
            ...
            >
              {"BHAVY WRITES".split("").map((char, i) => (
                <motion.span
                  ...
                  className="inline-block gradient-text bg-gradient-to-r from-primary via-accent to-secondary"
                >
                  {char === " " ? "\u00A0" : char}
                </motion.span>
              ))}
            ...
            <motion.p
              ...
              className="text-white/40 text-base sm:text-lg font-light tracking-wide"
            >
      ...
      <AnimatePresence>
        {showEasterEgg && (
          ...
          >
            <p className="text-white/30 text-sm sm:text-base font-light italic tracking-wide">
              &ldquo;Every story begins in darkness.&rdquo;
            </p>
          </motion.div>
        )}
      </AnimatePresence>
      ...
      {phase !== "moonrise" && (
        <button
          onClick={toggleSound}
          className="absolute bottom-8 right-8 w-10 h-10 rounded-full border border-white/8 bg-white/3 backdrop-blur-sm flex items-center justify-center text-white/30 hover:text-white/50 hover:border-white/15 transition-all text-xs"
